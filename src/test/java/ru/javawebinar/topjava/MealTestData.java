...
//        assertThat(actual).usingComparatorForFields((obj1, obj2) -> 0, "id", "dateTime", "description", "calories").usingRecursiveComparison().isEqualTo(expected);
...
//        assertThat(actual).usingRecursiveComparison().comparingOnlyFields("id", "dateTime", "description", "calories").isEqualTo(expected);
        assertThat(actual).usingRecursiveComparison().isEqualTo(expected);
    }
}

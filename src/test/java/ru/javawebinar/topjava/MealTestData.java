...
//            new Meal(3,LocalDateTime.of(2020, Month.JANUARY, 30, 19, 0), "Ужин", 500),
//            new Meal(4,LocalDateTime.of(2020, Month.JANUARY, 31, 10, 0), "Завтрак", 600),
//            new Meal(5,LocalDateTime.of(2020, Month.JANUARY, 31, 13, 0), "Обед", 1100),
//            new Meal(6,LocalDateTime.of(2020, Month.JANUARY, 31, 19, 0), "Ужин", 400)
//    );
//
//    public static final List<Meal> adminMeals = Arrays.asList(
//            new Meal(7,LocalDateTime.of(2020, Month.JANUARY, 30, 10, 0), "Завтрак", 700),
//            new Meal(8,LocalDateTime.of(2020, Month.JANUARY, 30, 13, 0), "Обед", 1200),
//            new Meal(9,LocalDateTime.of(2020, Month.JANUARY, 30, 19, 0), "Ужин", 800),
//            new Meal(10, LocalDateTime.of(2020, Month.JANUARY, 31, 10, 0), "Завтрак", 700),
//            new Meal(11, LocalDateTime.of(2020, Month.JANUARY, 31, 13, 0), "Обед", 900),
//            new Meal(12, LocalDateTime.of(2020, Month.JANUARY, 31, 19, 0), "Ужин", 450)
//    );
